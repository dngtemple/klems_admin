      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex justify-between items-center">
          ...
          <div className="space-x-2">
            <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Today's Bookings</button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {appointments.length === 0 ? (
            <div className="col-span-full text-center text-gray-500 text-lg">No appointments found</div>
          ) : (
              ...
              <tbody className="text-gray-600 text-sm">
                {appointments.map((appointment, index) => (
                  <tr key={appointment._id} className="border-t hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2">{new Date(appointment.updatedAt).toLocaleString()}</td>
                  </tr>
                ))}
              </tbody>
            </table>
